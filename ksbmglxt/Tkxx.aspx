...
<div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ksbmglxtConStr %>" SelectCommand="SELECT Tkxx.*,ROW_NUMBER() OVER (ORDER BY Tkxx.id ASC) AS xh FROM [Tkxx]"></asp:SqlDataSource>
</div>
</asp:Content>
